 ...
 * -----
 *
 * architectsofthewestkingdom.view.php
 *
 ...
 * particular, you can set here the values of variables elements defined in architectsofthewestkingdom_architectsofthewestkingdom.tpl (elements
...
class view_architectsofthewestkingdom_architectsofthewestkingdom extends game_view
{
    protected function getGameName()
    {
  	...
  	{		
        ...
        $this->page->begin_block("architectsofthewestkingdom_architectsofthewestkingdom", "player");
        foreach ($player_positions as $player_id => $dir) {
